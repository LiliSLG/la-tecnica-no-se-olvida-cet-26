...
import { Map, Globe, Layers, AlertTriangle } from 'lucide-react'; // BarChart3 removed as it was unused
  ...
  return (
    <div className="space-y-8">
      <header className="text-center py-8 bg-gradient-to-r from-primary/5 to-accent/5 rounded-lg shadow">
        ...
        <h1 className="text-4xl font-bold text-primary mb-2">Mapas</h1>
        <p className="text-lg text-foreground/80">Explorando el contexto geográfico y ecológico a través de visualizaciones interactivas.</p>
      </header>

      <Card className="shadow-lg">
        <CardHeader>
          <CardTitle className="flex items-center gap-2 text-primary"><Map className="h-6 w-6" /> Sobre esta Sección</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4 text-foreground/80">
          <p>
            Esta sección utiliza herramientas como Google Earth Engine (GEE), una plataforma de análisis geoespacial a escala planetaria, 
            que nos permite visualizar y analizar imágenes satelitales, datos climáticos, topográficos y otra información geográfica.
          </p>
          <p>
            En "La técnica no se olvida", los mapas y visualizaciones aquí presentes buscan complementar el archivo de conocimiento técnico y rural. 
            Mostrarán mapas interactivos, visualizaciones de datos ambientales y análisis espaciales que ayudarán a
