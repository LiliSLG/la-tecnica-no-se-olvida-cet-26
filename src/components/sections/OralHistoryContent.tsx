...
// Mock Data
/*
const mockInterviews: Entrevista[] = [
  {
    id: "1",
    tituloSaber: "Memorias de la Tierra: Don José",
    intervieweeName: "José Hernández",
    type: "audio",
    mediaUrl: "#",
    summary:
      "Un relato conmovedor sobre las tradiciones agrícolas y los cambios en el campo a lo largo de 70 años.",
    imageUrl: "https://placehold.co/600x400.png?b=1",
    date: "2023-05-15",
    dataAiHint: "elderly farmer",
  },
  {
    id: "2",
    tituloSaber: "El Arte de Tejer en la Patagonia: Doña María",
    intervieweeName: "María Silva",
    type: "video",
    mediaUrl: "#",
    summary:
      "Demostración y explicación de las técnicas ancestrales de tejido de lana, un legado familiar.",
    imageUrl: "https://placehold.co/600x400.png?b=2",
    date: "2023-07-22",
    dataAiHint: "woman weaving",
  },
  {
    id: "3",
    tituloSaber: "Vida y Oficios Rurales: Familia González",
    intervieweeName: "Familia González",
    type: "text",
    content:
      "Transcripción de una charla profunda sobre los desafíos y satisfacciones de la vida rural, abarcando múltiples generaciones y oficios.",
    summary:
      "Una mirada multigeneracional a los oficios y la vida cotidiana en el campo.",
    imageUrl: "https://placehold.co/600x400.png?b=3",
    date: "2023-09-10",
    dataAiHint: "rural family",
  },
  {
    id: "4",
    tituloSaber: "Sabores de Antaño: Recetas Tradicionales",
    intervieweeName: "Carmen Rodriguez",
    type: "video",
    mediaUrl: "#",
    summary:
      "Doña Carmen comparte recetas familiares transmitidas de generación en generación, cocinando platos típicos de la región.",
    imageUrl: "https://placehold.co/600x400.png?b=4",
    date: "2024-01-20",
    dataAiHint: "traditional cooking",
  },
];
*/

const InterviewCard = ({ interview }: { interview: Entrevista & {dataAiHint?: string} }) => {
  const [formattedDate, setFormattedDate] = useState<string | null>(null);

  useEffect(() => {
    if (interview.fechaGrabacionORecopilacion) {
      const parts = interview.fechaGrabacionORecopilacion.split("-");
      if (parts.length === 3) {
  ...
  }, [interview.fechaGrabacionORecopilacion]);

  return (
    <Card className="overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col">
      {interview.urlVideoExterno && (
        <div className="relative h-56 w-full">
          <Image
            src={interview.urlVideoExterno}
            alt={interview.tituloSaber}
            layout="fill"
            objectFit="cover"
      ...
      <CardHeader>
        <CardTitle className="text-xl text-primary">
          {interview.tituloSaber}
        </CardTitle>
        <CardDescription className="text-sm text-muted-foreground">
          Entrevista con: {interview.intervieweeName} -{" "}
          {formattedDate !== null ? formattedDate : "Cargando fecha..."}
        </CardDescription>
      </CardHeader>
      <CardContent className="flex-grow space-y-2">
        <p className="text-foreground/80 text-sm h-20 overflow-hidden">
          {interview.summary}
        </p>
        <Badge
          variant={
