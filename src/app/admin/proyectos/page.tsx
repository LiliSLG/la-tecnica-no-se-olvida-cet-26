...
import { ProyectosClientPage } from '@/components/admin/proyectos/ProyectosClientPage';
...
export default async function ProyectosAdminPage() {
  try {
    ...
    return <ProyectosClientPage allProyectos={allProyectos || []} />;
  } catch (error) {
    ...
    return (
      <div className="p-4">
        ...
        <p className="text-red-500">
          Ha ocurrido un error al cargar los proyectos. Por favor, intente nuevamente.
        </p>
      </div>
    );
  }
